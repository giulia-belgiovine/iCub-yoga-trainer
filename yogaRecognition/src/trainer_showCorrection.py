...
class YogaTrainer(object):
    ...
    def _load_yoga_poses(self):
        ...
        for current_dir in list_dir:
            ...
            self.yoga_show_correction[level] = {}   # added by Mati
            ...
            for f in yoga_files:
                ...
                self.yoga_show_correction[level][pose_name] = yoga_dict["show_correction"]   # added by Mati
    ...
    def get_pose_feedback(self, current_pose):
        ...
        if joint_to_fix is None:
            ...
            show_correct = self.show_correction[self.current_level][target_pose_name][joint_to_fix][0]    # added by Mati
            return f"{action_msg}", show_correct    # added by Mati
